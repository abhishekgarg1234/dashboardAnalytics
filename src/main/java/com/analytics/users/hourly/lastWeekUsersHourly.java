package com.analytics.users.hourly;
...
public class lastWeekUsersHourly extends utils {
	 public GaData getResults(Analytics analytics, String profileId) throws IOException {
		    return analytics.data().ga()
		        .get("ga:" + profileId, "7daysAgo", "7daysAgo", "ga:users")
		  ...
		  long startTime=getStartOfDayInSeconds() - 604800;
		    ...
		    if (results != null && !results.getRows().isEmpty()) {
		          ...
		          for(List<String> session : results.getRows()){
		              ...
		              String data="lastWeekUsersHourly"+ " " + session.get(1) + " " + startTime;
